...
goog.dom.isFocusableTabIndex = function(a) {
  ...
  if(b && b.specified) {
    return a = a.tabIndex, goog.isNumber(a) && a >= 0 && a < 32768
  }
  return!1
};
...
bot.locators.xpath.evaluate_ = function(a, b, c) {
  ...
  try {
    ...
    if(!(goog.userAgent.GECKO && f.name == "NS_ERROR_ILLEGAL_VALUE")) {
...
bot.locators.xpath.single = function(a, b) {
  var c = function() {
    ...
    if(c) {
      return c = c.singleNodeValue, goog.userAgent.OPERA ? c : c || null
    }else {
      if(b.selectSingleNode) {
        return c = goog.dom.getOwnerDocument(b), c.setProperty && c.setProperty("SelectionLanguage", "XPath"), b.selectSingleNode(a)
      }
    }
    return null
  }();
...
bot.locators.xpath.many = function(a, b) {
  var c = function() {
    ...
    if(c) {
      ...
      if(b.selectNodes) {
        return c = goog.dom.getOwnerDocument(b), c.setProperty && c.setProperty("SelectionLanguage", "XPath"), b.selectNodes(a)
      }
    }
    return[]
  }();
...
bot.userAgent.isEngineVersion = function(a) {
  return bot.userAgent.FIREFOX_EXTENSION ? bot.userAgent.FIREFOX_EXTENSION_IS_ENGINE_VERSION_(a) : goog.userAgent.IE ? goog.string.compareVersions(document.documentMode, a) >= 0 : goog.userAgent.isVersion(a)
};
bot.userAgent.isProductVersion = function(a) {
  return bot.userAgent.FIREFOX_EXTENSION ? bot.userAgent.FIREFOX_EXTENSION_IS_PRODUCT_VERSION_(a) : goog.userAgent.product.ANDROID ? goog.string.compareVersions(bot.userAgent.ANDROID_VERSION_, a) >= 0 : goog.userAgent.product.isVersion(a)
};
...
goog.style.getClientViewportElement = function(a) {
  ...
  if(goog.userAgent.IE && !goog.userAgent.isDocumentMode(9) && !goog.dom.getDomHelper(a).isCss1CompatMode()) {
    return a.body
  }
...
goog.style.getSizeWithDisplay_ = function(a) {
  ...
  if((!goog.isDef(b) || d) && a.getBoundingClientRect) {
    return a = goog.style.getBoundingClientRect_(a), new goog.math.Size(a.right - a.left, a.bottom - a.top)
  }
...
bot.dom.getProperty = function(a, b) {
  ...
  b == "value" && bot.dom.isElement(a, goog.dom.TagName.OPTION) && !bot.dom.hasAttribute(a, b) && (d = goog.dom.getRawTextContent(a));
  return d
};
...
bot.dom.getAttribute = function(a, b) {
  ...
  if(goog.array.contains(bot.dom.BOOLEAN_ATTRIBUTES_, b)) {
    return bot.userAgent.IE_DOC_PRE9 && c.value == "false" ? null : "true"
  }
...
bot.dom.isTextual = function(a) {
  ...
  if(bot.dom.isContentEditable(a)) {
    return!0
  }
  return!1
};
bot.dom.isContentEditable = function(a) {
  function b(a) {
    return a.contentEditable == "inherit" ? (a = bot.dom.getParentElement(a)) ? b(a) : !1 : a.contentEditable == "true"
  }
  if(!goog.isDef(a.contentEditable)) {
    return!1
  }
  if(!goog.userAgent.IE && goog.isDef(a.isContentEditable)) {
...
bot.dom.isShown = function(a, b) {
  ...
  if(bot.dom.isElement(a, goog.dom.TagName.NOSCRIPT)) {
    return!1
  }
...
bot.dom.appendVisibleTextLinesFromTextNode_ = function(a, b, c, d) {
  ...
  a = c == "pre" || c == "pre-wrap" ? a.replace(/[ \f\t\v\u2028\u2029]/g, "\u00a0") : a.replace(/[\ \f\t\v\u2028\u2029]+/g, " ");
...
bot.dom.isScrolledIntoView = function(a, b) {
  ...
  return b ? (e = goog.style.getPageOffset(a), e = goog.math.Coordinate.sum(e, b), d.contains(e)) : (e = goog.style.getBounds(a).toBox(), goog.math.Box.intersects(d, e))
};
bot.Device = function() {
...
bot.Device.prototype.fireMouseEvent = function(a, b, c, d) {
  ...
  b = {clientX:b.x, clientY:b.y, button:c, altKey:!1, ctrlKey:!1, shiftKey:!1, metaKey:!1, wheelDelta:0, relatedTarget:d || null};
    ...
    if(bot.Device.EXPLICIT_FOLLOW_LINK_) {
      for(var e = this.element_;e;e = e.parentNode) {
        if(bot.dom.isElement(e, goog.dom.TagName.A)) {
          ...
          if(bot.Device.isFormSubmitElement_(e)) {
            d = e;
            break
          }
        }
...
bot.Device.prototype.focusOnElement = function() {
  ...
  if(b && (goog.isFunction(b.blur) || goog.userAgent.IE && goog.isObject(b.blur))) {
    try {
      ...
      if(!(goog.userAgent.IE && c.message == "Unspecified error.")) {
        throw c;
      }
    }
  ...
  if(goog.isFunction(a.focus) || goog.userAgent.IE && goog.isObject(a.focus)) {
    return goog.userAgent.OPERA && bot.userAgent.isEngineVersion(11) && !bot.dom.isShown(a) ? bot.events.fire(a, bot.events.EventType.FOCUS) : a.focus(), !0
  }
  return!1
};
bot.Device.EXPLICIT_FOLLOW_LINK_ = goog.userAgent.IE || goog.userAgent.GECKO && !bot.userAgent.FIREFOX_EXTENSION || bot.userAgent.FIREFOX_EXTENSION && !bot.userAgent.isProductVersion(4);
bot.Device.CAN_SYNTHESISED_EVENTS_FOLLOW_LINKS_ = bot.userAgent.FIREFOX_EXTENSION && bot.userAgent.isProductVersion(4);
bot.Device.SYNTHESISED_EVENTS_CAN_OPEN_JAVASCRIPT_WINDOWS_ = bot.userAgent.FIREFOX_EXTENSION;
bot.Device.isFormSubmitElement_ = function(a) {
  if(bot.dom.isElement(a, goog.dom.TagName.INPUT)) {
...
bot.Device.shouldFollowHref_ = function(a) {
  ...
  if(a.target || a.href.toLowerCase().indexOf("javascript") == 0) {
...
bot.Device.prototype.toggleRadioButtonOrCheckbox_ = function(a) {
  if(!goog.userAgent.GECKO && !goog.userAgent.WEBKIT && !(a && this.element_.type.toLowerCase() == "radio")) {
    this.element_.checked = !a, goog.userAgent.OPERA && !bot.userAgent.isEngineVersion(11) && bot.events.fire(this.element_, bot.events.EventType.CHANGE)
  }
};
...
bot.events.MouseEventFactory_.prototype.create = function(a, b) {
  ...
  if(bot.userAgent.IE_DOC_PRE9) {
    ...
    this == bot.events.EventType.MOUSEWHEEL && Object.defineProperty && e("wheelDelta", b.wheelDelta)
  }else {
...
"DOMMouseScroll" : "mousewheel", !0, !0), KEYDOWN:new bot.events.KeyboardEventFactory_("keydown", !0, !0), KEYPRESS:new bot.events.KeyboardEventFactory_("keypress", !0, !0), KEYUP:new bot.events.KeyboardEventFactory_("keyup", !0, !0), TOUCHEND:new bot.events.TouchEventFactory_("touchend", !0, !0), TOUCHMOVE:new bot.events.TouchEventFactory_("touchmove", !0, !0), TOUCHSTART:new bot.events.TouchEventFactory_("touchstart", !0, !0)};
...
bot.Keyboard.prototype.pressKey = function(a) {
  ...
  if(b || goog.userAgent.GECKO) {
    if((!this.requiresKeyPress_(a) || this.fireKeyEvent_(bot.events.EventType.KEYPRESS, a, !b)) && this.editable_ && b) {
      if(a.character) {
...
bot.Keyboard.prototype.updateOnBackspaceOrDelete_ = function(a) {
  if(!goog.userAgent.GECKO) {
    ...
    a = !(b[0] == this.getElement().value.length || b[1] == 0);
...
goog.disposeAll = function() {
  for(var a = 0, b = arguments.length;a < b;++a) {
    var c = arguments[a];
    goog.isArrayLike(c) ? goog.disposeAll.apply(null, c) : goog.dispose(c)
  }
};
...
goog.dom.browserrange.IeRange.prototype.removeContents = function() {
  if(!this.isCollapsed() && this.range_.htmlText) {
    ...
    try {
      var e = a.nextSibling;
      if(a == b && a.parentNode && a.nodeType == goog.dom.NodeType.TEXT && e && e.nodeType == goog.dom.NodeType.TEXT) {
        a.nodeValue += e.nodeValue, goog.dom.removeNode(e), this.range_ = goog.dom.browserrange.IeRange.getBrowserRangeForNode_(c), this.range_.move("character", d), this.clearCachedValues_()
      }
    }catch(f) {
    }
  }
...
bot.Mouse.prototype.fireMousedown_ = function() {
  ...
  if(c && a && b != bot.dom.getActiveElement(this.getElement())) {
    return!1
  }
  return c
};
...
bot.Mouse.prototype.fireMouseEvent_ = function(a, b) {
  this.hasEverInteracted_ = !0;
  return this.fireMouseEvent(a, this.clientXY_, this.getButtonValue_(a), b)
};
...
goog.events.cleanUp_ = function(a, b, c, d) {
  if(!d.locked_ && d.needsCleanup_) {
    ...
    d.length = f;
    d.needsCleanup_ = !1;
    f == 0 && (delete goog.events.listenerTree_[a][b][c], goog.events.listenerTree_[a][b].count_--, goog.events.listenerTree_[a][b].count_ == 0 && (delete goog.events.listenerTree_[a][b], goog.events.listenerTree_[a].count_--), goog.events.listenerTree_[a].count_ == 0 && delete goog.events.listenerTree_[a])
  }
};
...
bot.Touchscreen.prototype.secondPressed_ = !1;
...
bot.Touchscreen.prototype.press = function(a) {
  ...
  if(a) {
    this.secondPressed_ = !0, this.touchIdentifier2_ = this.touchCounter_++
  }
...
bot.Touchscreen.prototype.release = function() {
  ...
  this.hasMovedAfterPress_ || (this.fireMouseEvent_(bot.events.EventType.MOUSEMOVE), this.fireMouseEvent_(bot.events.EventType.MOUSEDOWN) && this.focusOnElement(), this.fireMouseEvent_(bot.events.EventType.MOUSEUP), this.clickElement(this.clientXY_, 0));
  this.elementPressed_ = null;
  this.secondPressed_ = !1
};
bot.Touchscreen.prototype.move = function(a, b, c) {
  ...
  if(goog.isDef(c)) {
    this.clientXY2_.x = c.x + a.x, this.clientXY2_.y = c.y + a.y
  }
  if(this.elementPressed_) {
    this.hasMovedAfterPress_ = !0, this.fireTouchEvent_(bot.events.EventType.TOUCHMOVE)
  }
};
...
bot.Touchscreen.prototype.fireTouchEvent_ = function(a) {
  ...
  var b = {touches:[], targetTouches:[], changedTouches:[], altKey:!1, ctrlKey:!1, shiftKey:!1, metaKey:!1, relatedTarget:null, scale:0, rotation:0};
  bot.Touchscreen.addTouch_(a, b, this.touchIdentifier_, this.clientXY_);
  this.secondPressed_ && bot.Touchscreen.addTouch_(a, b, this.touchIdentifier2_, this.clientXY2_);
  return bot.events.fire(this.elementPressed_, a, b)
};
bot.Touchscreen.addTouch_ = function(a, b, c, d) {
  c = {identifier:goog.userAgent.product.ANDROID ? 0 : c, screenX:d.x, screenY:d.y, clientX:d.x, clientY:d.y, pageX:d.x, pageY:d.y};
  b.changedTouches.push(c);
  if(a == bot.events.EventType.TOUCHSTART || a == bot.events.EventType.TOUCHMOVE) {
    b.touches.push(c), b.targetTouches.push(c)
  }
};
bot.Touchscreen.prototype.fireMouseEvent_ = function(a) {
  if(!this.elementPressed_) {
    throw new bot.Error(bot.ErrorCode.UNKNOWN_ERROR, "Should never fire a mouse event when touchscreen is not pressed.");
  }
  return this.fireMouseEvent(a, this.clientXY_, 0)
};
...
bot.locators.css.containsUnquotedComma_ = function(a) {
  return a.split(/(,)(?=(?:[^']|'[^']*')*$)/).length > 1 && a.split(/(,)(?=(?:[^"]|"[^"]*")*$)/).length > 1
};
bot.locators.id = {};
...
bot.action.clear = function(a) {
  ...
  if(a.value) {
    a.value = "", bot.events.fire(a, bot.events.EventType.CHANGE)
  }
  if(bot.dom.isContentEditable(a)) {
    a.innerHTML = " "
  }
...
bot.html5.IS_SAFARI5_WINDOWS_ = goog.userAgent.WINDOWS && goog.userAgent.product.SAFARI && bot.userAgent.isProductVersion(5) && !bot.userAgent.isProductVersion(6);
...
webdriver.atoms.element.getAttribute = function(a, b) {
  ...
  if(bot.dom.isElement(a, goog.dom.TagName.IMG) && d == "src" || c && d == "href") {
...
webdriver.atoms.inject.dom.getSize = function(a) {
  return bot.inject.executeScript(bot.dom.getElementSize_, [a], !0)
};
...
webdriver.atoms.inject.action.submit = function(a) {
  bot.inject.executeScript(bot.action.submit, [a], !0)
};
webdriver.atoms.inject.action.clear = function(a) {
  bot.inject.executeScript(bot.action.clear, [a], !0)
};
...
core.events.getEventFactory_ = function(a) {
  var b = bot.events.EventType[a.toUpperCase()];
  if(b) {
    return b
  }
  return{create:function(b) {
    b = goog.dom.getOwnerDocument(b);
    bot.events.IE_NO_W3C_EVENTS_ ? b = b.createEventObject() : (b = b.createEvent("HTMLEvents"), b.initEvent(a, !0, !0));
    return b
  }}
};
...
core.events.replaceText_ = function(a, b) {
  bot.events.fire(a, bot.events.EventType.FOCUS, {bubble:!1});
  ...
  if(bot.dom.isElement(a, goog.dom.TagName.BODY)) {
    ...
    goog.userAgent.GECKO && bot.userAgent.isEngineVersion(8) ? XPCNativeWrapper(a).value = d : a.value = d
  }
  try {
    d = a, bot.userAgent.FIREFOX_EXTENSION && Components && Components.classes && XPCNativeWrapper && (d = new XPCNativeWrapper(a)), bot.events.fire(d, bot.events.EventType.CHANGE)
  }catch(e) {
  }
};
...
core.inject.removeElementIdPrefix_ = function(a) {
  if(goog.isArray(a)) {
    ...
    if(a && goog.isObject(a) && !goog.isFunction(a) && goog.object.containsKey(a, bot.inject.ELEMENT_KEY)) {
      ...
      if(b.substring(0, core.inject.ELEMENT_ID_PREFIX.length) === core.inject.ELEMENT_ID_PREFIX) {
        return a[bot.inject.ELEMENT_KEY] = b.substring(core.inject.ELEMENT_ID_PREFIX.length), a
      }
      return goog.object.map(a, core.inject.removeElementIdPrefix_)
    }
  }
  return a
};
core.inject.addElementIdPrefix_ = function(a) {
  if(goog.isArray(a)) {
    return goog.array.map(a, core.inject.addElementIdPrefix_)
  }else {
    if(a && goog.isObject(a) && !goog.isFunction(a)) {
      if(goog.object.containsKey(a, bot.inject.ELEMENT_KEY)) {
        return a[bot.inject.ELEMENT_KEY] = core.inject.ELEMENT_ID_PREFIX + a[bot.inject.ELEMENT_KEY], a
      }
      return goog.object.map(a, core.inject.addElementIdPrefix_)
    }
  }
  return a
};
